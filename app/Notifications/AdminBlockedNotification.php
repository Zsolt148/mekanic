...
class AdminBlockedNotification extends Notification implements ShouldQueue
{
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
			->subject('Proaktív felhasználó blokkolva')
			->greeting('Proaktív felhasználó blokkolva')
			->line("Kedves $notifiable->name")
			->line('Azért kapta ezt az email-t, mert a proaktív rendszerben ' . $this->admin->name .
