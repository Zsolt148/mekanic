<template>
    <auth-layout>
        ...
        <v-layout align-center justify-center>
            <v-card outlined elevation="0" class="auth--card">
                ...
                <v-card-text class="pa-0">
                    <v-form>
                        ...
                        <v-btn elevation="0" @click="submit" v-on:keyup.enter="submit" block color="primary" class="mt-6" :loading="form.processing">
