...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'workplace_size' => 'Workplace size',
        'workplace_county' => 'County',
        'workplace_zip' => 'Zip',
        'workplace_city' => 'City',
        ...
        'start_of_employment' => "Start of employment",
        ...
        "work_order_hours" => "Work order hours",
        ...
        "time" => "Time",
        "id_number" => "Invoice ID",
        "subject" => "Invocie subject",
        "gross" => "Gross",
        "net" => "Net",
        ...
        "invoice_items.*.quantity_unit" => "Quantity unit",
        "invoice_items.*.unit_price" => "Unitp rice",
        "invoice_items.*.tax_percent" => "VAT key",
        "date" => "Date",
