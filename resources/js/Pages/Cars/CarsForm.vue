    ...
    <v-form>
        <v-col cols="12" md="6">
            <v-row>
                ...
                <v-col cols="6">
                    <v-text-field
                        v-model="form.milegae"
                        :disabled="disabled"
                        :error-messages="form.errors.milegae"
                        :label="trans('Mileage') + '*'"
                        name="milegae"
                        hide-details="auto"
                        type="number"
                ...
                <v-col cols="12">
                    <v-text-field
                        ...
                        :disabled="disabled"
                        :error-messages="form.errors.chassis_number"
                ...
                <v-col cols="12">
                    <v-text-field
                        v-model="form.motor_number"
                        :disabled="disabled"
                        :error-messages="form.errors.motor_number"
                        :label="trans('Motor number') + '*'"
                        name="motor_number"
                        hide-details="auto"
                        filled />
                </v-col>
                ...
                <v-col cols="6">
                    <v-text-field
                        ...
                        :disabled="disabled"
                        :error-messages="form.errors.vintage"
                        :label="trans('Vintage') + '*'"
                        name="vintage"
                        min="1950"
                        max="2023" 
                ...
                <v-col cols="6">
                    ...
                    >
                        <template v-slot:activator="{ on, attrs }">
                            <v-text-field
                                v-model="form.ti_validity"
                                :label="trans('Technical inspection validity') + '*'"
                                :error-messages="form.errors.ti_validity"
                                :disabled="disabled"
                                filled
                                hide-details='auto'
                                readonly
