        ...
        <v-row class="mt-5">
            <v-col cols="12" md="6">
                    ...
                    <v-col>
                        ...
                        <v-col>
                            <v-row style="position: relative">
                                ...
                                <v-btn color="primary" elevation="0" class="mt-4" @click="deletePhoto" v-if="user.profile_photo_path">
                                    {{trans('Remove Photo')}}
                                </v-btn>
                            </v-row>
                        </v-col>
                ...
                <v-row>
                    ...
                    <v-col>
                        <v-btn color="primary" elevation="0" @click="updatePassword" :loading="passwordForm.processing">
